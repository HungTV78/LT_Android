...
public class Bai4_Lab8 extends AppCompatActivity {
    Button btnReadJsCS;
    ListView lvCS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bai4_lab8);
    ...
    public ArrayList<String> loadJsonCS() throws IOException,
            JSONException {
        ArrayList<String> arrayListCS = new ArrayList<>();
        InputStream
                inputStream=getResources().getAssets().open("b.json");
