package com.example.lab9_letanhung_2001210520.bai4_lab9.Controller;
...
public class KhoaHandler extends SQLiteOpenHelper {
    ...
    public void deleteKhoa(Khoa k) {
        SQLiteDatabase db = SQLiteDatabase.openDatabase(path, null, SQLiteDatabase.OPEN_READWRITE);
        db.delete(TABLE_NAME, "makhoa=?", new String[]{String.valueOf(k.getMaKhoa())});
        db.close();
    }
}
